                        ...
                        <form class="form-horizontal m-t-20" action="{{route('user.login')}}" method="post">
                          @csrf
                            ...
                            <div class="form-group text-center row m-t-20">
                                <div class="col-12">
                                    <button style="background: black" class="btn text-white  btn-block waves-effect waves-light" type="submit">Sign In</button>
                                </div>
                            </div>
                            <div class="form-group m-t-10 mb-0 row">
                                {{-- <div class="col-sm-7 m-t-20">
                                    <a href="" class="text-white"><i class="mdi mdi-lock"></i> Forgot your password?</a>
                                </div> --}}
