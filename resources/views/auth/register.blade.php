...
<head>
    ...
    <body>
        ...
        <div class="wrapper-page">
            <div class="card">
                <div class="card-body" style="background: #bf9c60">
                    <h3 class="text-center mt-0 m-b-15">
                        <a  href="{{route('login')}}" class="logo logo-admin"><img src="images/whitelogo (1).png" height="114" alt="logo"></a>
                    </h3>
                          ...
                          @csrf 
                            <div class="form-group row">
                                <div class="col-12">
                                    ...
                                    <input class="form-control" value="2" type="hidden" name="type"  placeholder="Email">
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-12">
                                    <input class="form-control" type="email" name="email"required="" placeholder="Useremail">
                            ...
                            <div class="form-group text-center row m-t-20">
                                <div class="col-12">
                                    <button style="background: black" class="btn text-white btn-block waves-effect waves-light" type="submit">Sign Up</button>
                                </div>
                            </div>

                            <div class="form-group m-t-10 mb-0 row">
                                <div class="col-12 m-t-20 text-center">
                                    <a href="{{route('login')}}"  class="text-white">Go to Sign In</a>
                                </div>
                            </div>
                        </form>
                    </div>
